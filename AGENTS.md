...
| Ticket | Evidence | Problem |
|---|---|---|
| **ACET-SEC-002** | Dependabot job `1397087686` | **`uuid@8.3.2` transitive CVE** — no fix available until upstream deps update their `uuid` pinning to `>= 14.0.0`. Dependabot reports `security_update_not_possible`. No action from this team until upstream resolves. |
